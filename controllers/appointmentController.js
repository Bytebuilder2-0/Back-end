...
const getAppointments = async (req, res) => {
  try {
    const appointments = await Appointment.find(
      {},
      "vehicleId vehicleNumber model issue services preferredDate preferredTime reason workload tech department status techMessage contactNumber payment appointmentId suggestion expectedDeliveryDate"
    );
